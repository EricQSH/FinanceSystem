			...
			public void actionPerformed(ActionEvent e) {
				...
				switch (curTab)
				{
					case 0:
						...
						accTable.setValueAt(account, 0, 1);
						String supplierno = (String) tableOrder.getValueAt(curOrder, 2);
						accTable.setValueAt(supplierno, 0, 2);
						String customerno = null;
						accTable.setValueAt(customerno, 0, 3);
						String productno = ino;
						accTable.setValueAt(productno, 0, 4);
						String samount = (String) tableOrder.getValueAt(curOrder, 6);
						accTable.setValueAt(samount, 0, 5);
						String dc = "Debit";
						accTable.setValueAt(dc, 0, 6);
						String description = "";
						Date date = (Date) tableOrder.getValueAt(curOrder, 7);
						accTable.setValueAt(date, 0, 8);
						String source = "o" + (String) tableOrder.getValueAt(curOrder, 0);
						accTable.setValueAt(source, 0, 9);
						String spayment = (String) tableOrder.getValueAt(curOrder, 3);
						if (spayment.contains("一年付一次"))
						{
							description = "一级供应商，一年后付款，当天记应付账款";
							accTable.setValueAt(description, 0, 7);
							//2
							accTable.setValueAt(voucherno, 1, 0);
							account = "应付账款-" + supplierno;
							accTable.setValueAt(account, 1, 1);
							accTable.setValueAt(supplierno, 1, 2);
							accTable.setValueAt(customerno, 1, 3);
							accTable.setValueAt(productno, 1, 4);
							accTable.setValueAt(samount, 1, 5);
							dc = "Credit";
							accTable.setValueAt(dc, 1, 6);
							accTable.setValueAt(description, 1, 7);
							accTable.setValueAt(date, 1, 8);
							accTable.setValueAt(source, 1, 9);
							//3
							accTable.setValueAt(voucherno, 2, 0);
							accTable.setValueAt(account, 2, 1);
							accTable.setValueAt(supplierno, 2, 2);
							accTable.setValueAt(customerno, 2, 3);
							accTable.setValueAt(productno, 2, 4);
							accTable.setValueAt(samount, 2, 5);
							dc = "Debit";
							accTable.setValueAt(dc, 2, 6);
							description = "一级供应商，一年后的付款，对应采购单";
							accTable.setValueAt(description, 2, 7);
							Calendar cal = Calendar.getInstance();
							cal.clear();
							cal.set(Calendar.YEAR, date.getYear()+1900);  
					        cal.roll(Calendar.DAY_OF_YEAR, -1);  
					        Date lastDate = cal.getTime();
							accTable.setValueAt(lastDate, 2, 8);
							accTable.setValueAt(source, 2, 9);
							//4
							accTable.setValueAt(voucherno, 3, 0);
							account = "银行存款";
							accTable.setValueAt(account, 3, 1);
							accTable.setValueAt(supplierno, 3, 2);
							accTable.setValueAt(customerno, 3, 3);
							accTable.setValueAt(productno, 3, 4);
							accTable.setValueAt(samount, 3, 5);
							dc = "Credit";
							accTable.setValueAt(dc, 3, 6);
							description = "一级供应商，一年后的付款，对应采购单";
							accTable.setValueAt(description, 3, 7);
							accTable.setValueAt(lastDate, 3, 8);
							accTable.setValueAt(source, 3, 9);
						}
					...
					case 4:
						...
						int fvmi = (Integer) tableSale.getValueAt(curSale, 8);
						voucherno = "   ";
						...
						supplierno = (String) tableSale.getValueAt(curSale, 0); //Cannot access!!!!!!!!!!!!!!!
						if (fvmi==0)
						{
							...
							accTable.setValueAt(customerno, 2, 3);
							accTable.setValueAt(productno, 2, 4);
							accTable.setValueAt(scost, 2, 5);
							dc = "Debit";
							accTable.setValueAt(dc, 2, 6);
							description = "减少库存，非供应商库存";
							accTable.setValueAt(description, 2, 7);
							accTable.setValueAt(date, 2, 8);
							accTable.setValueAt(source, 2, 9);
							//4
							accTable.setValueAt(voucherno, 3, 0);
							...
							accTable.setValueAt(customerno, 3, 3);
							accTable.setValueAt(productno, 3, 4);
							accTable.setValueAt(scost, 3, 5);
							dc = "Credit";
							accTable.setValueAt(dc, 3, 6);
							accTable.setValueAt(description, 3, 7);
							accTable.setValueAt(date, 3, 8);
							accTable.setValueAt(source, 3, 9);
						}
						else
						{
							...
							accTable.setValueAt(account, 4, 1);
							accTable.setValueAt(supplierno, 4, 2);
							accTable.setValueAt(customerno, 4, 3);
							accTable.setValueAt(productno, 4, 4);
							accTable.setValueAt(scost, 4, 5);
							dc = "Debit";
							accTable.setValueAt(dc, 4, 6);
							description = "月末按卖了多少付款给供应商";
							accTable.setValueAt(description, 4, 7);
							accTable.setValueAt(lastDate, 4, 8);
							accTable.setValueAt(source, 4, 9);
							//6
							accTable.setValueAt(voucherno, 5, 0);
							account = "银行存款";
							accTable.setValueAt(account, 5, 1);
							accTable.setValueAt(supplierno, 5, 2);
							accTable.setValueAt(customerno, 5, 3);
							accTable.setValueAt(productno, 5, 4);
							accTable.setValueAt(scost, 5, 5);
							dc = "Credit";
							accTable.setValueAt(dc, 5, 6);
							accTable.setValueAt(description, 5, 7);
							accTable.setValueAt(lastDate, 5, 8);
							accTable.setValueAt(source, 5, 9);
							//7
							accTable.setValueAt(voucherno, 6, 0);
							account = "营业成本-" + productno;
							accTable.setValueAt(account, 6, 1);
							accTable.setValueAt(supplierno, 6, 2);
							accTable.setValueAt(customerno, 6, 3);
							accTable.setValueAt(productno, 6, 4);
							accTable.setValueAt(scost, 6, 5);
							dc = "Debit";
							accTable.setValueAt(dc, 6, 6);
							description = "减少库存，供应商库存";
							accTable.setValueAt(description, 6, 7);
							accTable.setValueAt(date, 6, 8);
							accTable.setValueAt(source, 6, 9);
							//8
							accTable.setValueAt(voucherno, 7, 0);
							account = "库存-" + productno;
							accTable.setValueAt(account, 7, 1);
							accTable.setValueAt(supplierno, 7, 2);
							accTable.setValueAt(customerno, 7, 3);
							accTable.setValueAt(productno, 7, 4);
							accTable.setValueAt(scost, 7, 5);
							dc = "Credit";
							accTable.setValueAt(dc, 7, 6);
							accTable.setValueAt(description, 7, 7);
							accTable.setValueAt(date, 7, 8);
							accTable.setValueAt(source, 7, 9);
						}
						tableSale.setValueAt(true, curSale, 9);
						break;
					default:;
				}
			}
